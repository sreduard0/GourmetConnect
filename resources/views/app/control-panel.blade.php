    ...
    <div class="card">
        <div class="card-header border-0">
            <div class="d-flex justify-content-between">
                <h3 class="card-title">Vendas em {{ date('M') }}</h3>
            </div>
        </div>
        <div class="card-body">
            <div class="d-flex">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="chart-responsive">
                        ...
                        <canvas id="rel-gda" style="display: block; width: 218px; height: 109px;" class="chartjs-render-monitor" width="218" height="109"></canvas>
                    </div>
...
// CIVIL
if (result.percentage.civil < 0) { $('#perCivil').html( '<strong class="text-danger"><i class="fas fa-arrow-down text-sm"></i> ' + result.percentage.civil + '% </strong>' ) } else if (result.percentage.civil> 0) {
    $('#perCivil').html(
    ...
    // Outra OM
    if (result.percentage.oom < 0) { $('#perOom').html( '<strong class="text-danger"><i class="fas fa-arrow-down text-sm"></i> ' + result.percentage.oom + '% </strong>' ) } else if (result.percentage.oom> 0) {
        $('#perOom').html(
        '<strong class="text-success"><i class="fas fa-arrow-up text-sm"></i> ' +
        ...
        // OM
        if (result.percentage.om < 0) { $('#perOm').html( '<strong class="text-danger"><i class="fas fa-arrow-down text-sm"></i> ' + result.percentage.om + '% </strong>' ) } else if (result.percentage.om> 0) {
            $('#perOm').html(
            '<strong class="text-success"><i class="fas fa-arrow-up text-sm"></i> ' +
